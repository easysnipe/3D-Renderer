public class Cube extends Prisim
{
    ...
    public void create3dPoints()
    {
        ...
        // points[0] = new Point(scale * -1,scale * 1,scale * -1); //
        // points[1] = new Point(scale * -1,scale * -1,scale); 
        // points[2] = new Point(scale,scale * -1,scale * -1); 
        // points[3] = new Point(scale * -1,scale,scale * -1); //
        // points[4] = new Point(scale * -1,scale,scale); 
        // points[5] = new Point(scale,scale * -1,scale); 
        // points[6] = new Point(scale,scale,scale * -1); 
    ...
    public void createLines()
    {
        ...
        // edges[2] = new Line(points[0], points[3]);
        // edges[3] = new Line(points[2], points[5]);
        // edges[4] = new Line(points[3], points[6]);
        // edges[5] = new Line(points[3], points[4]);//
        // edges[6] = new Line(points[4], points[7]);
        // edges[7] = new Line(points[6], points[7]);
        // edges[8] = new Line(points[7], points[5]);//
        // edges[9] = new Line(points[5], points[1]);
        // edges[10] = new Line(points[4], points[1]);
        // edges[11] = new Line(points[2], points[6]);//
